...
class Block extends AbstractEntity
{
    ...
    {  
        ...
        $nodeValue = sprintf('<?php $this->comp[%d] = $this->comp[%d]->addSlot("%s", Template::template("***block", %s)->withName("%s")->withData($this->scopeData)->setSlots($this->slots)); ?>', 
            $this->depth, 
            $this->context->depth, 
            $this->attrs['slot'], 
            $dataString,
    ...
    public function simpleNodeContext()
    {
        ...
        $nodeValue = sprintf('<?php $this->comp[%d] = Template::template("***block", %s)->withName("%s")->withData($this->scopeData)->setSlots($this->slots); ?>', 
            $this->depth, 
            $dataString,
            $this->name
        );
