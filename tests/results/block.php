...
$this->comp[0]->render($this->data); ?></b><?php $this->comp[0] = Parsed::template("***block", [])->withName("b2")->setSlots($this->slots);$this->comp[1] = $this->comp[0]->addSlot("b2", Parsed::template("b2?slot=26", ['_index' => '1'])->setSlots($this->slots));$this->comp[0]->render($this->data); ?> <?php 
};
...
<?php $this->comp[0] = Parsed::template("block/a", []);; foreach ([1,2] as $a) { 
