...
Parsed::$templates['props/c_slot_default?id=61db006f3e4a5'] = function ($data, $slots) {
...
$comp1 = $comp0->addSlot('default', Parsed::template('props/c_slot_default?id=61db006f3e4a5', []));
