...
Parsed::$templates['props/c'] = function ($data, $slots) {
    extract($data); $_attrs = array_intersect_key($data, array_flip(array_diff($_attrs, ['data','slots','slot',])));
     ?><?php $data['val'] = [1,2]; $data['name'] = "myname"; ?><c><?php 
...
Parsed::$templates['props/c_slot_default?id=61d95e3daa5da'] = function ($data, $slots) {
...
$comp1 = $comp0->addSlot('default', Parsed::template('props/c_slot_default?id=61d95e3daa5da', []));
