...
Parsed::$templates['props/c_slot_default?id=61df0d3b383ef'] = function ($data, $slots) {
...
$comp1 = $comp0->addSlot('default', Parsed::template('props/c_slot_default?id=61df0d3b383ef', []));
