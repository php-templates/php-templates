...
Parsed::$templates['props/c_slot_default?id=61fede1b146a5'] = function ($data, $slots) {
...
$this->comp[1] = $this->comp[0]->addSlot('default', Parsed::template('props/c_slot_default?id=61fede1b146a5', []));
