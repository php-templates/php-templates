...
}if (empty($this->slots("sn9"))) {; ?>djdh<?php ;}$this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("comp/comp_slot?slot=default&id=6", []));$this->comp[0]->render($this->data);?> <?php 
};
