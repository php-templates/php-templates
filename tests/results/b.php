...
$this->comp[1] = $this->comp[0]->addSlot("b122", Parsed::template("b122?slot=11", ['_index' => '1']));
...
$this->comp[1] = $this->comp[0]->addSlot("b1", Parsed::template("b1?slot=8", ['_index' => '1']));
$this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("***block", ['_index' => '2'])->withName("b12")->setSlots($this->slots));
$this->comp[2] = $this->comp[1]->addSlot("b12", Parsed::template("b12?slot=9", ['_index' => '1']));
$this->comp[2] = $this->comp[1]->addSlot("b12", Parsed::template("b12?slot=10", ['_index' => '2']));
$this->comp[0]->render($this->data); ?>
</b><?php $this->comp[0] = Parsed::template("***block", [])->withName("b2")->setSlots($this->slots);$this->comp[1] = $this->comp[0]->addSlot("b2", Parsed::template("b2?slot=12", ['_index' => '1']));$this->comp[0]->render($this->data); ?> <?php 
};
