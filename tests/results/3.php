...
Parsed::$templates['block_b1_slot?id=61e51e25562c2'] = function ($data, $slots) {
    extract($this->data); $_attrs = array_diff_key($this->attrs, array_flip(['k',]));
     ?><b11><?php echo htmlspecialchars($k); ?></b11><?php 
};
Parsed::$templates['b1?id=61e51e2556216'] = function ($data, $slots) {
...
$this->block['b1']->addSlot('b1', Parsed::template('block_b1_slot?id=61e51e25562c2', ['k' => $k, '_index' => '1']))->setSlots($slots);
...
Parsed::$templates['./cases/3'] = function ($data, $slots) {
    extract($this->data); $_attrs = array_diff_key($this->attrs, array_flip(['slots','this',]));
     ?><!DOCTYPE html>
<html><body><?php Parsed::template('b1?id=61e51e2556216', [])->setSlots($slots)->render($this->data); ?>
