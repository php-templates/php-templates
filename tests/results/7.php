...
Parsed::$templates['slot_default?id=61e51e2566f35'] = function ($data, $slots) {
...
Parsed::$templates['slot_default?id=61e51e2567618'] = function ($data, $slots) {
...
Parsed::$templates['components/form-group'] = function ($data, $slots) {
    extract($this->data); $_attrs = array_diff_key($this->attrs, array_flip(['this','slot','slots','error',]));
    ...
    else  {$this->comp[0] = Parsed::template('slot_default?id=61e51e2566f35', []);
    ...
    else  {$this->comp[0] = Parsed::template('slot_default?id=61e51e2567618', []);
...
Parsed::$templates['./cases/7'] = function ($data, $slots) {
    extract($this->data); $_attrs = array_diff_key($this->attrs, array_flip(['this',]));
     ?><!DOCTYPE html>
<html><body><?php $this->comp[0] = Parsed::template('components/form-group', ['type' => 'checkbox', 'options' => ['o1' => 'A', 'o2' => 'B'], 'name' => 'options', 'label' => 'Options', 'values' => ['o1']]);
