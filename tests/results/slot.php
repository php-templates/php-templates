...
$this->attrs = $this->data;
extract($data); ?> <div class="comp_slot_default">
    <span>
<?php foreach ($this->slots("default") as $_slot) {
$_slot->render(array_merge($this->scopeData, []));
...
$_slot->render(array_merge($this->scopeData, []));
}  if (empty($this->slots("slot2"))) {  $this->comp[1] = Parsed::template("comp/comp_slot", []);  $this->comp[1]->render($this->scopeData);  } ?></div>
    <div>
<?php foreach ($this->slots("slot2") as $_slot) {
$_slot->render(array_merge($this->scopeData, []));
}  if (empty($this->slots("slot2"))) {  $this->comp[1] = Parsed::template("comp/comp_slot", []);  $this->comp[2] = $this->comp[1]->addSlot("default", Parsed::template("comp/comp_slot?slot=default&id=56", ['slot' => 'default', '_index' => '0'])->setSlots($this->slots));  $this->comp[1]->render($this->scopeData);  } ?></div>
...
}  if (empty($this->slots("sn5"))) { ;  $this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("sn5?slot=default&id=58", []));  }  $this->comp[0]->render($this->scopeData);  $this->comp[0] = Parsed::template("comp/comp_slot", []);  foreach ($this->slots("sn6") as $_slot) {
$this->comp[0]->addSlot("default", $_slot);
}  if (empty($this->slots("sn6"))) { ;  $this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("sn6?slot=default&id=59", []));  }  $this->comp[0]->render($this->scopeData);  $this->comp[0] = Parsed::template("comp/comp_slot", []);  $this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("comp/comp_slot?slot=default&id=60", ['slot' => 'default', '_index' => '0'])->setSlots($this->slots));  $this->comp[0]->render($this->scopeData);  $this->comp[0] = Parsed::template("comp/comp_slot", []);  $this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("comp/comp_slot?slot=default&id=61", ['slot' => 'default', '_index' => '0'])->setSlots($this->slots));  foreach ($this->slots("sn9") as $_slot) {
$this->comp[0]->addSlot("default", $_slot);
}  if (empty($this->slots("sn9"))) { ;  $this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("sn9?slot=default&id=62", []));  $this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("sn9?slot=default&id=63", []));  }  $this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("comp/comp_slot?slot=default&id=64", ['slot' => 'default', '_index' => '0'])->setSlots($this->slots));  $this->comp[0]->render($this->scopeData);  };
...
Parsed::$templates['./temp/slot'] = function ($data, $slots) {
$this->attrs = $this->data;
extract($data);  $this->comp[0] = Parsed::template("comp/comp_slot", []);  $this->comp[0]->render($this->scopeData); ?>

-----

<?php $this->comp[0] = Parsed::template("comp/comp_slot_default", []);  $this->comp[0]->render($this->scopeData); ?>

-----

<?php $this->comp[0] = Parsed::template("comp/comp_illegat_slot_in_slot", []);  $this->comp[0]->render($this->scopeData); ?>

-----

<?php $this->comp[0] = Parsed::template("comp/slot_default_in_slot_default", []);  $this->comp[0]->render($this->scopeData); ?>

-----

<?php $this->comp[0] = Parsed::template("comp/nested_slot", []);  $this->comp[1] = $this->comp[0]->addSlot("sn", Parsed::template("comp/nested_slot?slot=sn&id=65", ['slot' => 'sn', '_index' => '0'])->setSlots($this->slots));  $this->comp[1] = $this->comp[0]->addSlot("sn1", Parsed::template("comp/nested_slot?slot=sn1&id=66", ['slot' => 'sn1', '_index' => '0'])->setSlots($this->slots));  $this->comp[1] = $this->comp[0]->addSlot("sn3", Parsed::template("comp/nested_slot?slot=sn3&id=67", ['slot' => 'sn3', '_index' => '0'])->setSlots($this->slots));  $this->comp[1] = $this->comp[0]->addSlot("sn5", Parsed::template("comp/simple", []));  $this->comp[1] = $this->comp[0]->addSlot("sn8", Parsed::template("comp/nested_slot?slot=sn8&id=68", ['slot' => 'sn8', '_index' => '0'])->setSlots($this->slots));  $this->comp[1] = $this->comp[0]->addSlot("sn9", Parsed::template("comp/nested_slot?slot=sn9&id=69", ['slot' => 'sn9', '_index' => '0'])->setSlots($this->slots));  $this->comp[0]->render($this->scopeData); ?>
