...
$this->comp[1] = $this->comp[0]->addSlot("b1", Parsed::template("b1?slot=17", ['_index' => '1'])->setSlots($this->slots));
...
$this->comp[1] = $this->comp[0]->addSlot("default", Parsed::template("comp/comp_slot?slot=default&id=16", ['slot' => 'default', '_index' => '0'])->setSlots($this->slots));
$this->comp[0]->render($this->data);
 ?>
