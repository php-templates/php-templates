...
foreach ([2,3] as $a) { 
$this->comp[1] = Parsed::template("comp/comp_slot", []);
$this->comp[2] = $this->comp[1]->addSlot("default", Parsed::template("comp/comp_slot?slot=default&id=14", ['slot' => 'default', '_index' => '0'])->setSlots($this->slots));
$this->comp[1]->render($this->data);
} 
}
 ?></div>
...
$this->comp[3] = $this->comp[2]->addSlot("default", Parsed::template("comp/comp_slot?slot=default&id=15", ['slot' => 'default', '_index' => '0'])->setSlots($this->slots));
$this->comp[1]->render($this->data);
} 
}
 ?>
