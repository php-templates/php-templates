<div class="form-group" :class="!empty($class) ? $class : ''">
    ...
    <slot>
        <input p-if="$type === 'text'" type="text" class="form-control" p-bind="$this->attrs()" :placeholder="$placeholder ?? $label">
        <input p-elseif="$type === 'number'" type="number" class="form-control" p-bind="$this->attrs()" :placeholder="$placeholder ?? $label">
        <input p-elseif="$type === 'email'" type="email" class="form-control" p-bind="$this->attrs()" :placeholder="$placeholder ?? $label">
