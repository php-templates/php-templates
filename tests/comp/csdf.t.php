<div class="comp_slot_default" p-foreach="[2] as $a">
    ...
    <div><slot name="slot2"><template is="comp/comp_slot" p-foreach="[2,3] as $a">foo</template></slot></div>
    <slot name="slot3"><template is="comp/comp_slot" p-foreach="[3,4] as $a"><template is="comp/comp_slot">bar</template></template></slot>
</div>